...
- 실행 시각: 2026-06-17 16:15:15
- 파일: `test_api_smoke.py`
- 결과: 총 22개 | ✅ PASS 22개 | ❌ FAIL 0개

---

| 날짜 | 파일 | 총 | PASS | FAIL |
|------|------|----|------|------|
| 2026-06-17 | `test_api_smoke.py` | 22 | 22 | 0 |

## 상세 내용

- ✅ PASS GET /api/v1/health/ → 200
- ✅ PASS POST /api/v1/auth/register → 201 → {'id': 1, 'username': 'smokeuser', 'email': 'smoke@test.com', 'is_active': True, 'created_at': '2026-06-17T07:15:14.485023'}
- ✅ PASS POST /api/v1/auth/login → 200
- ✅ PASS POST /api/v1/auth/login (wrong pw) → 401
- ✅ PASS POST /api/v1/accounts/ → 201 → {'id': 1, 'name': 'Smoke Account', 'currency': 'KRW', 'initial_balance': 1000000.0, 'current_balance': 1000000.0, 'created_at': '2026-06-17T07:15:14.698148'}
- ✅ PASS GET /api/v1/accounts/ → 200
- ✅ PASS GET /api/v1/accounts/1 → 200
- ✅ PASS GET /api/v1/accounts/9999 → 404
- ✅ PASS POST /api/v1/accounts/ (음수잔고) → 422
- ✅ PASS POST /api/v1/orders/ → 201
- ✅ PASS GET /api/v1/orders/ → 200
- ✅ PASS GET /api/v1/orders/1 → 200
